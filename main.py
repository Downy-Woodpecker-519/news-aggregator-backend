...
# Fetch news for given topic and countries
def fetch_news(topic, countries, max_articles):
    all_articles = []
    articles_per_country = max_articles // len(countries) if countries else max_articles
...
def get_news():
    ...
    news_data = {
        ...
        "Business & Technology News (Canada & USA)": fetch_news("business", ["ca", "us"], 20) + fetch_news("technology", ["ca", "us"], 10)
    }
